    ...
    template: ` <div [class]="'flex min-h-screen  ' + (layoutService.isDarkTheme() ? 'layout-dark' : 'layout-light')">
            <div
                *ngIf="layoutService.isDarkTheme()"
                ...
                style="max-width: 490px; background-image: url('/images/pages/forgot-password-ondark.png'); background-repeat: no-repeat; background-size: cover"
            ></div>
            <div
                *ngIf="!layoutService.isDarkTheme()"
                class="w-6/12 h-screen hidden md:block shrink-0"
                style="max-width: 490px; background-image: url('/images/pages/forgot-password-onlight.png'); background-repeat: no-repeat; background-size: cover"
            ></div>
