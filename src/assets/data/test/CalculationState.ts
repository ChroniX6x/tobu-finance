...
import { GroupType } from "@/calculation/domain/group-type";
import { CalculationStateModel } from "@/calculation/state/calculation.state";

export const data: CalculationStateModel = {
  selectedMonth: DateTime.now().toFormat('MM/yyyy'),
  calculationGroup: [
    {
      id: 'test',
      verifiedChange: 135,
